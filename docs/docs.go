...
const docTemplate = `{
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/pkg_common_middleware_handler.Login"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "github.com_devops-base_devops-admin_pkg_common_middleware_handler.Login": {
            "type": "object",
            "required": [
                "code",
                "password",
        ...
        "models.SysMenu": {
            ...
            "properties": {
                ...
                "id": {
                    "description": "MenuId     int       ` + "`" + `json:\"menuId\" gorm:\"primaryKey;autoIncrement\"` + "`" + `",
                    "type": "integer"
                },
                "isFrame": {
                    "type": "string"
        ...
        "pkg_common_middleware_handler.Login": {
            "type": "object",
            "required": [
                "code",
                "password",
