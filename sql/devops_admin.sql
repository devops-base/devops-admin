...
INSERT INTO `sys_menu` (`id`, `menu_name`, `title`, `icon`, `path`, `paths`, `menu_type`, `action`, `permission`, `parent_id`, `no_cache`, `breadcrumb`, `component`, `sort`, `visible`, `is_frame`, `create_by`, `update_by`, `created_at`, `updated_at`, `deleted_at`) VALUES (545, 'Dashboard', '数据预览', 'data', '/dashboard', '/0/545', 'M', '', '', 0, 0, '', '/dashboard', 10, '0', '1', 1, 1, NULL, '2023-04-13 14:17:18.118', NULL);
COMMIT;
